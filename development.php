...
<body>
   ...
   <div class = "container">
      <article>
         <h2>The Development of Fruit</h2>
         <figure>
            <img class="scale" src="images/devoffruit.jpg" alt="Development of Fruit">
            <figcaption> The development sequence of a typical drupe, the nectarine (Prunus persica) over a 7.5 month period, from bud formation in early winter to fruit ripening in midsummer (see image page for further information)
            </figcaption>
         </figure>
         <div class="fruit_info">
            <h3>Where Does Fruit Come From?</h3>
            <p>
            ...
            <h3>Modes of Fruit Development</h3>
            <p>
               Apocarpous fruits develop from a single flower having one or more separate carpels, and they are the simplest fruits. Syncarpous fruits develop from a single gynoecium having two or more carpels fused together.
